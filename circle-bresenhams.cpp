...
void drawCircleUsingBresenhamAlgorithm(int centerX, int centerY, int radius) {
    std::vector<float> vertices;

    // Bresenham's Circle Drawing Algorithm to calculate vertices
    int x = 0;
    int y = radius;
...
void display() {
    ...
    drawCircleUsingBresenhamAlgorithm(3, 3, 4); // Center (3,3), Radius 4
    // Draw the diameter
